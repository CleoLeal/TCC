...
<head>
    ...
    <body link="white" vlink="#2DCF00">
        ...
        <div class="container">
            ...
            <div class="itens">
                <a href="./index.php" class="linkitens">Quem Somos</a>
            </div>
            <div class="itens">
        ...
        <footer>
            ...
            <div class="containerlink">
                ...
                <a href="./../../toquenarede/Cliente/homeCliente.php" class="footer-itens">Home</a>
                <a href="./../../toquenarede/Cliente/Telalocalizacao1.php" class="footer-itens">Localização</a>
                <a href="./../../toquenarede/Cliente/arenasCliente.php" class="footer-itens">Arenas</a>
            </div>
            <div class="containerlink">
            ...
            <div class="containerlink">
                <table>
                    <tr>
                        <td colspan="2">
                            <p class="footertitleN">Equipe</p>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <a href="https://www.instagram.com/cleo.leal/" target="_blank" class="footer-itens">Cléo</a>&nbsp&nbsp
                        </td>
                        <td>
                            <a href="https://www.instagram.com/cristian_silva_tamaxi/" target="_blank" class="footer-itens">Cristian</a>
                        </td>
                    </tr>
                    <tr>
                        <td>
                    ...
                    <tr>
                        <td colspan="2">
                            <a href="https://www.instagram.com/rayssa_anjos_portugal/" target="_blank" class="footer-itensR">Rayssa</a>
                        </td>
                    </tr>                    
                </table>
            </div>
